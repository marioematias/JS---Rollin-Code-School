...
//!Cuando se precione cancelar (la función prompt devuelve valor null cuando se cancela), cortar el bucle;
//!Convertir los números introducidos de String a Number para evitar que los tome como texto;
//!Establecer alerta si lo que se introduce no es un número (la función Not A Number sirve para eso);
